        ...
        <section className="glass-card rounded-[30px] p-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm font-bold leading-6 text-slate-600">
                오늘 실습의 메인은 독서 공유 & 책 읽기 프로그램 로드맵입니다. 아래에서 실습 자료를 먼저 보고, 프롬프트 메모판·일반 게시판·자기소개 게시판으로 이어갑니다.
              </p>
            </div>
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-4">
            <a href="#reading-roadmap" className="rounded-[24px] border border-amber-200 bg-amber-50/80 p-4 transition hover:-translate-y-1">
              ...
              <p className="font-black text-slate-950">메인. 독서공유 로드맵</p>
              <p className="mt-1 text-sm font-bold leading-6 text-slate-500">첨부한 HTML 실습 자료를 크게 봅니다.</p>
            </a>
        ...
        <section id="reading-roadmap" className="glass-card rounded-[30px] p-5">
          <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="text-2xl font-black text-slate-950">독서 공유 & 책 읽기 프로그램 수강생 로드맵</p>
              <p className="mt-2 max-w-3xl text-sm font-bold leading-6 text-slate-600">
                첨부 HTML을 프로젝트 안에 보관하고, 외부 광고/로컬 스크립트는 제거했습니다. 수강생은 이 로드맵을 보면서 MVP, 도서검색 API, Supabase 저장, GitHub push 순서로 실습합니다.
              </p>
            </div>
          ...
          <div className="overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-card">
            <iframe title="독서 공유 책읽기 프로그램 실습 로드맵" src="/practice/reading-roadmap-5-4mini.html" className="h-[720px] w-full bg-white" />
          </div>
        </section>
